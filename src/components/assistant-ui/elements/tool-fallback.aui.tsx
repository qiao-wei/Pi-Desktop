...
function ToolFallbackTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-tool-fallback-trigger group/trigger text-muted-foreground hover:text-foreground flex w-fit origin-left items-center gap-1.5 py-1 text-[14px] transition-[color,scale] active:scale-[0.98]",
        className,
      )}
      {...props}
    >
...
function ToolFallbackContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex flex-col gap-1.5 ps-6 pt-1 pb-1.5 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:animate-none",
...
function ToolFallbackResult({
  ...
  return (
    ...
    >
      ...
      <pre className="aui-tool-fallback-result-content bg-muted/50 text-foreground/90 mt-1 max-h-64 overflow-y-auto rounded-md p-2.5 text-[13px] leading-5 whitespace-pre-wrap">
